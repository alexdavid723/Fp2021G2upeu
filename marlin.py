...
def Ejercicio2MMQ():
  ...
  sueldo=930
  bono=0
  puntos=int(input("Ingrese con base a la puntuacion optenido: "))
  # Proceso
...
def Ejercicio3MMQ():
  ...
  # Proceso
  if edad>=70:
   print("ingiere la vacuna tipo C.")
  elif edad>=16 and edad<70 and sexo=="m":
   print("ingiere la vacuna tipo B.")
  elif edad>=16 and edad<69 and sexo=="h":
   print("ingiere la vacuna tipo A.")
  elif edad<16:
   print("ingiere la vacuna tipo A.")

def Ejercicio4MMQada
